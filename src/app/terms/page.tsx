...
export default function TermsPage() {
  return (
    <LegalPage title="Website terms" summary="These terms cover Yamzo Uttara's online menu, ordering, account, and tracking services.">
      ...
      <section><h2>Test mode</h2><p>Orders clearly marked as test orders are for approved staff testing only. They are not customer purchases, are excluded from live revenue and inventory reporting, and may be permanently deleted by an authorized operator.</p></section>
