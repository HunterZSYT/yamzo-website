...
export default function PrivacyPage() {
  return (
    <LegalPage title="Privacy notice" summary="This notice explains the information used to place, fulfil, and track a Yamzo Uttara order.">
      ...
      <section><h2>Retention and choices</h2><p>Website orders, including test orders, are retained for restaurant operations, support, audit, and legal needs. Approved staff may cancel an order, but cannot permanently delete its operational record. You may ask about your personal information by emailing <a href="mailto:admin@yamzouttara.com">admin@yamzouttara.com</a>.</p></section>
